...
public class HotelsController {
	...
	public ResponseEntity<List<HotelResource>> getHotels(@PathVariable(value = "cityId") String cityId,
														 @RequestHeader(value = "checkInDate") @DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'") DateTime checkInDate, 
														 @RequestHeader(value = "checkOutDate") @DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'") DateTime checkOutDate,
